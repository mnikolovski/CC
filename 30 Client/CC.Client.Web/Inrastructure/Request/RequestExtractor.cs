...
namespace CC.Client.Web.Inrastructure.Request
{
    public class RequestExtractor
    {
        ...
        /// <returns></returns>
        public RequestData GetTrackingStatistic(bool recordLocalRequests = false)
        {
            var _tracking = new RequestData();
            ...
            _tracking.Username = MvcFormsSecurityProvider.CurrentUser.Username;
